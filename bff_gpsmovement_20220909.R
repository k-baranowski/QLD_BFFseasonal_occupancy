...
t2[,c(1,3,5:10)]<- NULL
write.csv(t2, "nightIDs_origin_allroosts_20220831.csv", row.names = F)
...
ff_dates<- data.frame(ff_return_frst$night_ID, ff_return_frst$time)
colnames(ff_dates)= c("night_ID", "time")
...
#write.csv(t3, "batnights_tracked_origin_seasons_20220831.csv", row.names = F)
